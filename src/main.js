...
const material = new THREE.MeshStandardMaterial({
  map: loader.load("static/images/textures/earth_day.jpg")
});
...
const earthLightMaterial = new THREE.MeshBasicMaterial({
  map: loader.load("static/images/textures/earth_light.jpg"),
...
const earthCloudeMaterial = new THREE.MeshBasicMaterial({
  map: loader.load("static/images/textures/earth_clouds.jpg"),
  // transparent: true,
  opacity: 0.1,
  blending: THREE.AdditiveBlending
});
